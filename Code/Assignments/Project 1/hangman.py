...
def play_hangman():
    ...
    while mistakes_made < MAX_GUESSES:
        ...
        letter_choice = raw_input("Enter a letter or guess the whole word: ").lower()
        if letter_choice == 'guess':
            guess_word = raw_input("Guess: ").lower()
            ...
            if letter_choice in letters_guessed:
                print "Try Again"
                continue
            else:
                letters_guessed += [letter_choice]
